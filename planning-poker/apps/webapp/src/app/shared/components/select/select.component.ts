...
import { ZardBadgeComponent } from 'apps/webapp/src/app/shared/components/badge';
import { ZardIconComponent } from 'apps/webapp/src/app/shared/components/icon';
import { ZardSelectItemComponent } from 'apps/webapp/src/app/shared/components/select/select-item.component';
import {
  selectContentVariants,
  selectTriggerVariants,
  selectVariants,
  type ZardSelectSizeVariants,
} from 'apps/webapp/src/app/shared/components/select/select.variants';
...
@Component({
  ...
  template: `
    <button
      ...
      (focus)="onFocus()"
    >
      <span class="flex min-w-0 flex-1 rounded-xl! h-8.5 flex-wrap items-center gap-2">
