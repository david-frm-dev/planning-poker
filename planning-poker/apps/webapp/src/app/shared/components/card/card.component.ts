...
import { ZardButtonComponent } from 'apps/webapp/src/app/shared/components/button/button.component';
    ...
    <ng-container zardId="card" #z="zardId">
      ...
      @if (title) {
        <div [class]="headerClasses()" data-slot="card-header">
          <div class="leading-none font-semibold text-2xl" [id]="titleId()" data-slot="card-title">
          ...
          @if (zAction()) {
            <button
              ...
              type="button"
              zType="link"
              class="col-start-2 row-span-2 row-start-1 self-start justify-self-end text-red"
