...
import { ZardIconComponent, type ZardIcon } from 'apps/webapp/src/app/shared/components/icon';
import {
  sidebarGroupLabelVariants,
  sidebarGroupVariants,
  sidebarTriggerVariants,
  sidebarVariants,
} from 'apps/webapp/src/app/shared/components/layout/layout.variants';
import { ZardStringTemplateOutletDirective } from 'apps/webapp/src/app/shared/core/directives/string-template-outlet/string-template-outlet.directive';
